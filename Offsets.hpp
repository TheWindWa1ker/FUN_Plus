...
// Core
constexpr uint64_t OFF_LEVEL = 0x16db770; //[Miscellaneous]->LevelName
constexpr uint64_t OFF_LOCAL_PLAYER = 0x2166fa8; //[Miscellaneous]->LocalPlayer
constexpr uint64_t OFF_ENTITY_LIST = 0x1db8548; //[Miscellaneous]->cl_entitylist

constexpr uint64_t OFF_NAME_LIST = 0xC5E1150; //[Miscellaneous]->NameList
constexpr uint64_t OFF_NAME_INDEX = 0x38; //nameIndex

// HUD
constexpr uint64_t OFF_VIEWRENDER = 0x73e0ad8; //[Miscellaneous]->ViewRender
...
constexpr uint64_t OFF_INATTACK = 0x073e1d58; //[Buttons]->in_attack
...
// Glow
constexpr uint64_t OFF_GLOW_HIGHLIGHTS = 0xB944E30; //HighlightSettings
...
constexpr long OFFSET_UID = 0x2528;								  //m_platformUserId=0x2578
constexpr long OFFSET_TIME_BASE = 0x2068;						  //m_currentFramePlayer.timeBase
constexpr long OFFSET_VIEWMODEL = 0x2cf8;						  //m_hViewModels

//身法
constexpr long OFFSET_IN_JUMP = 0x073e1e70;
constexpr long OFFSET_IN_DUCK = 0x073e1f58;
constexpr long OFFSET_IN_FORWARD = 0x073e1ca8;
constexpr long OFFSET_IN_backward = 0x073e1cd0;
constexpr long OFFSET_IN_moveleft = 0x073e1c98;
constexpr long OFFSET_IN_moveright = 0x073e1cc0;
constexpr long OFFSET_GRAPPLE = 0x2c20;							  //m_grapple
constexpr long OFFSET_GRAPPLEACTIVED = 0x2cb0;					  //m_grappleActive
constexpr long OFFSET_GRAPPLEATTACHED = 0x0048;					  //m_grappleAttached=0x0048